...
export default function Model({color,camera,logo}) {
    ...
    <group ref={group}  dispose={null}>
      <group rotation={[-Math.PI / 2, 0, 0]}>
        <group rotation={[Math.PI / 2, 0, 0]} scale={0.01}>
          <group scale={500}>
            <mesh geometry={nodes.Body_Mic_0.geometry} material-color={snap.items.laces} />
            <mesh geometry={nodes.Body_Bezel_0.geometry} material={materials.Bezel} />
            <mesh material-color={snap.items.body}  geometry={nodes.Body_Body_0.geometry} material={materials.Body} />
            <mesh geometry={nodes.Body_Wallpaper_0.geometry} material={materials.Wallpaper} />
            <mesh material-color={snap.items.body} geometry={nodes.Body_Camera_Glass_0.geometry} material={materials.Camera_Glass} />
            <mesh material-color={snap.items.body} geometry={nodes.Body_Lens_0.geometry} material={materials.Lens} />
            <mesh material-color={snap.items.body} geometry={nodes.Body_Material_0.geometry} material={materials.Material} />
            ...
            <mesh material-color={snap.items.camera} geometry={nodes.Camera_Camera_Frame001_0.geometry} material={materials['Camera_Frame.001']} />
            ...
            <mesh material-color={snap.items.logo} geometry={nodes.Apple_Logo_Logo_0.geometry} material={materials.Logo} />
            ...
            <mesh geometry={nodes.Frame_Frame_0.geometry} material={materials.Frame}  material-color={snap.items.logo}/>
